...
const int CENTIPEDE_SPEED = 1; /**< The speed of the centipede */
const int CENTIPEDE_LENGTH = 8; /**< The length of the centipede */
const int CENTIPEDE_BODYPART_SIZE = 10; /**< The size of each body part of the centipede */
const Position CENTIPEDE_SPAWN_POSITION = {500, 100}; /**< The spawn position of the centipede */
